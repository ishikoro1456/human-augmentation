...
def main() -> None:
    ...
    parser.add_argument("--without-diff", default="data/results/questionnaire_v2_total_diff.tsv")
    parser.add_argument("--with-diff", default="data/results/questionnaire_v2_total_diff_with_intention.tsv")
    parser.add_argument("--out-tsv", default="data/results/questionnaire_v2_stats.tsv")
    parser.add_argument("--out-md", default="data/results/questionnaire_v2_stats.md")
    parser.add_argument("--out-fig-dir", default="data/figures/questionnaire")
