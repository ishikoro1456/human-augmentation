...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[
            "data/results/anonymized/speaker_v2_anonymized.csv",
            "data/results/anonymized/listener_v2_anonymized.csv",
        ],
    )
    parser.add_argument("--name-column", default="氏名")
    parser.add_argument("--timestamp-column", default="タイムスタンプ")
    parser.add_argument("--out-dir", default="data/results/anonymized_labeled")
