...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[
            "data/questionnaire/derived/speaker_v2.csv",
            "data/questionnaire/derived/listener_v2.csv",
        ],
    )
    parser.add_argument("--name-column", default="氏名")
    parser.add_argument("--out-dir", default="data/questionnaire/derived/anonymized")
