...
def main() -> None:
    ...
    parser.add_argument("--speaker", default="data/questionnaire/derived/anonymized_labeled/speaker_v2_anonymized_labeled.csv")
    parser.add_argument("--listener", default="data/questionnaire/derived/anonymized_labeled/listener_v2_anonymized_labeled.csv")
    parser.add_argument("--out-dir", default="paper_materials/figures/questionnaire")
    parser.add_argument("--out-stem", default="speaker_listener_total_paired_v3")
    parser.add_argument("--out-tsv-dir", default="data/questionnaire/derived")
    args = parser.parse_args()

    _configure_plot_style(font_scale=1.40)

    speaker_path = _resolve_path(args.speaker, "data/questionnaire/derived/anonymized/speaker_v2_anonymized.csv")
    listener_path = _resolve_path(args.listener, "data/questionnaire/derived/anonymized/listener_v2_anonymized.csv")
