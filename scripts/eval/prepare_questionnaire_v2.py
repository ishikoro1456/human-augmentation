...
def main() -> None:
    ...
    parser.add_argument("--speaker-input", default="data/questionnaire/raw/speaker_input.csv")
    parser.add_argument("--listener-input", default="data/questionnaire/raw/listener_input.csv")
    parser.add_argument("--speaker-output", default="data/questionnaire/derived/speaker_v2.csv")
    parser.add_argument("--listener-output", default="data/questionnaire/derived/listener_v2.csv")
    ...
    parser.add_argument("--name-aliases", default="data/questionnaire/raw/name_aliases.tsv")
