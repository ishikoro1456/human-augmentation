...
def main() -> None:
    ...
    parser.add_argument("--speaker", default="data/questionnaire/raw/speaker_input.csv")
    parser.add_argument("--listener", default="data/questionnaire/raw/listener_input.csv")
